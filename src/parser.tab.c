...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_VAR = 3,                        /* VAR  */
  YYSYMBOL_CMD_NONE = 4,                   /* CMD_NONE  */
  YYSYMBOL_CMD_MONO = 5,                   /* CMD_MONO  */
  YYSYMBOL_CMD_BIN = 6,                    /* CMD_BIN  */
  YYSYMBOL_CMD_SET = 7,                    /* CMD_SET  */
  ...
  YYSYMBOL_set_content = 20,               /* set_content  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "VAR", "CMD_NONE",
  "CMD_MONO", "CMD_BIN", "CMD_SET", "ASSIGN", "SMC", "OPENKEY", "CLOSEKEY",
  "COLON", "$accept", "program", "statement", "cmd_none_stmt",
  "cmd_mono_stmt", "cmd_bin_stmt", "set_declaration_stmt", "set_content",
  "elements", YY_NULLPTR
};
